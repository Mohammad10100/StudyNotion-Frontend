...
const Course_Card = ({course, Margin, Height}) => {
  ...
  return (
    <div className='swiper-slide swiper-slide-active swiper-slide-next w-full my-8'>
        <Link to={`/courses/${course._id}`}>
            <div>
                <div className=' rounded-lg mx-1 bg-richblack-5'>
                    <img 
